...
from Model_Raw_w3 import DUVModel

# os.environ["PYTORCH_NO_CUDA_MEMORY_CACHING"] = "1"
os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"
os.environ["CUDA_VISIBLE_DEVICES"] = '0'
os.environ["HDF5_USE_FILE_LOCKING"] = "FALSE"
BACKBONE = 'Model-Raw-w3'
...
def main(csv, ckpt):
    ...
    summary_str = str(summary(model, input_size=[(batch_size, 3, 439, 439), (batch_size, 3, 439, 439), (batch_size, 3, 439, 439)], verbose=0))
